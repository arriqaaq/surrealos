...
pub(crate) struct CommitPipeline {
	...
	shutdown: AtomicBool,
	// Write stall controller for backpressure
...
mod tests {
	...
	impl crate::stall::WriteStallCountProvider for NoopStallProvider {
	...
	fn test_write_stall() -> Arc<WriteStallController> {
		let provider: Arc<dyn crate::stall::WriteStallCountProvider> = Arc::new(NoopStallProvider);
